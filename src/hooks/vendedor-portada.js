...
module.exports = (options = {}) => {
  return async context => {
    // PRE-condicion, tiene que tener "nombre_corto_vendedor"
    if (!context.params.query.nombre_corto_vendedor) {
      return context;
    }

    const nombreCorto = context.params.query.nombre_corto_vendedor;
